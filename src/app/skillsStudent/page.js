                ...
                <div className="bg-error-200 dark:bg-error-black dark:outline dark:outline-offset-2 dark:outline-white-500 dark:shadow-[0_4px_36px_16px_rgba(255,255,255,0.25)] w-10/12 md:w-6/12 h-4/6 rounded-3xl">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between">
                        <div className="flex-auto lg:w-64">
							...
							{skills.map((skill, index) => <div key={index} className=" bg-error-gray hover:bg-[#FF0000] rounded-2xl text-lg h-10 w-20 text-error-white text-center" onClick={(e) =>deleteSkill(index)}>{skill} </div>)}
                            </div>
							<div className="pt-10 pl-10">
                                    <Button className="bg-error-300 rounded-2xl hover:bg-error-100 text-lg h-12 w-36" onClick={onSubmit}>
                                        Continue
                                    </Button>
                            </div>
                        </div>
