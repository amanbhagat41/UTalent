            ...
            <div className="dark:bg-error-black">
                <div className="flex flex-col min-h-screen dark:bg-error-black">
                    ...
                    <section className="relative flex items-center justify-center h-auto py-24">
                        ...
                        ></Image>
                        <div className="z-10">
                            <h1 className="text-error-white text-[10vw] text-center">
                                About Us
                            </h1>
                            <p className="text-center text-error-white w-[40vw] font-bold">
                                We are looking to revolutionize the Freelance
                                market for college students in hopes of growing
                                their skills, improving portfolios, and giving
                                real-world applications in their respective
                                fields. With UTalent younger generations are
                                given an new opportunity.
                            </p>
                        </div>
                    </section>
                    <div className="flex flex-col w-full items-center">
                            ...
                            <div className="flex-1 flex justify-center md:justify-start md:pl-6 w-[30vw] mr-44">
                                <div>
                                    <h2 className="text-4xl font-semibold text-start mb-10">
                                        Creating a New <br></br>Opportunity for
                                        Students
                                    </h2>
                                    <div className="w-[20vw] h-[.3vw] -mt-5 bg-error-300 rounded-lg float-left"></div>
                                    <p className="text-3xl font-light">
                                        We provide students with an alternative
                                        option to typical work experiences. With
                                        a network of employers seeking various
                                        projects, we provide students with
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center mt-32">
                            ...
                            <div className="flex-1 flex justify-center md:justify-start md:pl-6 w-[30vw] ml-44">
                                <div>
                                    <h2 className="text-4xl font-semibold text-end mb-10">
                                        {" "}
                                        A place for employers eager to <br></br>
                                        tap into fresh, innovative talent.
                                    </h2>
                                    <div className="w-[20vw] h-[.3vw] -mt-5 bg-error-300 rounded-lg float-right"></div>
                                    <p className="text-3xl font-light text-end">
                                        UTalent streamlines the process of
                                        connecting with motivated and skilled
                                        students, inspiring collaborations that
                                        create innovation and success. Employers
                                        are given an opportunity to invest in
                                        young talent in a low risk manner.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="flex flex-col md:flex-row items-center justify-center mt-32">
                            <div className="flex-1 flex justify-center md:justify-start md:pl-6 w-[30vw] mr-44">
                                <div>
                                    <h2 className="text-4xl font-semibold text-start mb-10">
                                        A Glimpse Into an <br></br>Alternative
                                        to Traditional Work{" "}
                                    </h2>
                                    <div className="w-[20vw] h-[.3vw] -mt-5 bg-error-300 rounded-lg float-left"></div>
                                    <p className="text-3xl font-light">
                                        UTalent offers students an alternative
                                        to traditional employment, empowering
                                        them to take control of their work
                                        experience and schedule. Giving the
                                        ability to explore diverse projects that
                ...
                <div className="flex flex-col items-center justify-center mt-32"></div>
                <div className="flex flex-col items-center justify-center mt-32">
                    <h2 className="text-center text-error-black text-5xl font-bold dark:text-error-white">
                        Founders
                    </h2>
                ...
                <div className="grid grid-cols-7 mt-10 gap-16 mb-40">
                    ...
                    <div>
                        ...
                        <p className="text-center mt-2 text-xl">
                            Students can apply themselves to jobs that they are
                            interested in and companies can select candidates
                    ...
                    <div>
                        ...
                        <p className="text-center mt-2 text-xl">
                            Requiring University verified accounts gives
                            companies confidence in their selection for
                            freelance work.
                        </p>
                    </div>
                    <div>
                        ...
                        <p className="text-center mt-2 text-xl">
                            By creating early connections with fresh talent
                            companies increase their reach to a new generation
                            of driven workers.
                        </p>
                    </div>
                    <div></div>
