...
import { NavigationMenuDemo } from "@/components/navJobPostingStudent";
...
export default function jobPostingStudent() {
  return (
    <>
    <div className="relative">
    <div className="flex flex-col h-[1662px]z dark:bg-[#222]">{/*Header*/}
      ...
      <div className=" justify-left ml-64 mr-64"> {/*Body*/}
        ...
        <div className="flex justify-center pt-5">
          ...
          <Button className='bg-error-300 rounded-3xl hover:bg-error-100 text-lg h-12 mt-8 dark:text-[#FFFFFF]'>Post a Bid</Button>
          </Link>
        </div>
      </div>
      ...
      <div>
        <footer className="bg-error-100 h-20 w-full relative left-0 bottom-0 mt-24 dark:bg-error-black">{/*Footer*/}
        <div className="flex items-center justify-between h-full">
